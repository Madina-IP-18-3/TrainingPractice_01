            ...
            do                                     
            {
                ...
                switch (shoose)                                            // Выборка решений
                {
                    ...
                    again:
                        ...
                        bool obnureshenie = false;         // Проверка на повторения использование нужного индекса


                        if (choice <= i && choice > 0)       // Проверка на ошибки: не введено ли число больше, чем кол-во записей в целом; индекс < 0
